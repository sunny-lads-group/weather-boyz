...
const PolicyTemplateCard = ({ template }: PolicyTemplateCardProps) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-200 flex flex-col h-full">
      ...
      <div className="space-y-3 flex-grow">
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm text-gray-900">
            {formatCurrency(template.min_coverage_amount)} - {formatCurrency(template.max_coverage_amount)}
          </span>
        </div>
        
        <div className="flex justify-between items-center">
          <span className="text-sm font-medium text-gray-700">Base Premium Rate:</span>
      ...
      <div className="mt-6 pt-4 border-t border-gray-100">
        <button 
          className="w-full bg-orange-500 text-white py-2 px-4 rounded-md text-sm font-medium hover:bg-orange-600 transition-colors duration-200 cursor-not-allowed opacity-50"
          disabled
        >
